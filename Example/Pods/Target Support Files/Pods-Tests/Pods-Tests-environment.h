...
// JDFGeometry
#define COCOAPODS_POD_AVAILABLE_JDFGeometry
#define COCOAPODS_VERSION_MAJOR_JDFGeometry 0
#define COCOAPODS_VERSION_MINOR_JDFGeometry 1
#define COCOAPODS_VERSION_PATCH_JDFGeometry 0
